...
# weight_path = 'model_frcnn_july11.hdf5'
class Options:
...
options = Options(test_path=test_path, num_rois=32)
...
for img_name in img_paths:
    ...
    # cv2.imshow('img', img)
    # cv2.waitKey(0)
    # cv2.imwrite('/media/yue/Seagate/A2D/Faster-RCNN Output/' + img_name, img)
    img_save = Image.fromarray(img)
    image_id = img_name.split('/')[-1]
    img_save.save('/media/lele/DATA/a2d_lele/output/' + image_id, 'PNG')